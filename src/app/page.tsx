...
const page = async() => {
  ...
  return (
    <section className='md:bg-[url("https://i.ytimg.com/vi/0yboGn8errU/maxresdefault.jpg")] bg-[url("https://i.ytimg.com/vi/0yboGn8errU/maxresdefault.jpg")] bg-cover bg-no-repeat bg-center h-full w-full'>
