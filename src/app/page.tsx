...
const page = async() => {
  ...
  return (
    <section className='md:bg-[url("/assets/gemini-banner.png")] bg-[url("/assets/gemini-phone-banner.png")] bg-cover bg-no-repeat bg-center h-full w-full'>
      <DevButton target='_blank' href='https://github.com/Amitabh-DevOps/Jenkins-shared-libraries.git' variant='v3' size='lg' asIcon rounded='full' className="text-4xl fixed top-4 right-4 text-white">
        <FaGithub />
      </DevButton>
