...
const page = async() => {
  ...
  return (
    <section className='md:bg-[url("public\assets\gemini-banner.png")] bg-[url("public\assets\gemini-phone-banner.png")] bg-cover bg-no-repeat bg-center h-full w-full'>
